import {
  ...
  export class RoutesChartCausesComponent implements OnInit, AfterViewInit {
  ...
  onResize() {
    ...
    tiempoPerdidoEnCadaTipoRetraso(causa,gruposViaje) {
      ...
      var cant=0;
      this.recorridoAAnalizar.viajes.filter(viajeFilter=>viajeFilter.orden==viajeOrden[0].orden)
      .forEach(viaje=>{
